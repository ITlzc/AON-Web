      ...
      <div class="reset-password-container">
        ...
        <div class="reset-password-content">
          ...
          <div class="form-group">
            ...
            />
            <span class="error-text" v-if="v$.code.$error">
...
const v$ = useVuelidate(rules, { code, password, confirmPassword })
...
async function handleConfirm() {
  ...
  if (!v$.value.$invalid) {
    spinning.value = true
    try {
      const res = await user_.resetPasswordConfirm(code.value, password.value)
      if (res) {
